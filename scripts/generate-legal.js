...
const PAGES = [
  { path: 'company/privacy-policy', title: 'Privacy Policy', date: 'March 15, 2026' },
  { path: 'company/terms-of-service', title: 'Terms of Service', date: 'January 10, 2026' },
  { path: 'company/cookie-policy', title: 'Cookie Policy', date: 'March 15, 2026' },
  { path: 'company/accessibility', title: 'Accessibility Commitment', date: 'February 22, 2026' },
  { path: 'company/sustainability', title: 'Sustainability & ESG', date: 'April 01, 2026' },
  { path: 'company/trade-compliance', title: 'Trade Compliance', date: 'November 05, 2025' },
  { path: 'company/anti-bribery', title: 'Anti-Bribery Policy', date: 'January 28, 2026' },
  { path: 'company/whistleblower', title: 'Whistleblower Reporting', date: 'March 01, 2026' },
  { path: 'company/investor-relations', title: 'Investor Relations', date: 'April 01, 2026' },
  { path: 'resources/media-kit', title: 'Brand & Media Kit', date: 'March 20, 2026' },
  { path: 'sitemap-page', title: 'HTML Sitemap', date: 'April 01, 2026' },
];

const generatePageContent = (title, date) => {
  return `"use client";
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-4xl">
        ...
        <div className="space-y-6 mb-16 animate-in fade-in slide-in-from-bottom-12 duration-1000">
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-white/10">
             ...
             <span className="text-[#ef4444] text-[10px] uppercase font-black tracking-widest">${date}</span>
          </div>
        </div>
...
PAGES.forEach(page => {
  ...
  fs.writeFileSync(path.join(dirPath, 'page.tsx'), generatePageContent(page.title, page.date));
});

console.log('Successfully generated 11 corporate legal pages.');
